...
class main_model(nn.Module):
    ...
    def __init__(self, num_classes, patch_size=1, in_chans=3, embed_dim=96, depths=(2, 2, 2, 2),
        ...
        self.conv_head = nn.Linear(24, num_classes)

        self.conv_head.weight.data.mul_(conv_head_init_scale)

        self.conv_head.bias.data.mul_(conv_head_init_scale)
        
        self.conv_head1 = nn.Linear(conv_dims[-1], 24)
        self.conv_head1.weight.data.mul_(conv_head_init_scale)
        self.conv_head1.bias.data.mul_(conv_head_init_scale)
...
class PatchEmbed(nn.Module):
    ...
    def __init__(self, patch_size=1, in_c=3, embed_dim=96, norm_layer=None):
